...
import vitalitus.springtestproject.controller.BookController;
...
class BookControllerTest {
    ...
    void createBook_ValidRequestDto_ReturnsBookDto() throws Exception {
        ...
        requestDto.setTitle("Spring in Action");
        requestDto.setAuthor("Craig Walls");
        requestDto.setPrice(BigDecimal.valueOf(1200));
        requestDto.setIsbn("978-1617294945");
        requestDto.setCategoryIds(List.of(1L));

        BookDto expectedDto = new BookDto();
        expectedDto.setId(1L);
        expectedDto.setTitle("Spring in Action");
        expectedDto.setAuthor("Craig Walls");
    ...
    void getBookById_ValidId_ReturnsBookDto() throws Exception {
        ...
        expectedDto.setAuthor("Robert C. Martin");
